...
def run():
    ...
    st.link_button('Котляров С.Н., Любавин А.В. 🖂 Оценка клинико-функциональных факторов, повышающих вероятность развития фибрилляции предсердий у больных ХОБЛ (в настоящее время статья с описанием исследования находится на стадии рецензирования. Для получения материалов исследования напишите нам)', 
